...
var schema = __importStar(require("./schema/index.js"));
// ─── pg Pool ──────────────────────────────────────────────────────────────────
exports.pool = new pg_1.Pool({
    ...
    ssl: env_js_1.env.NODE_ENV !== 'development'
...
exports.db = (0, node_postgres_1.drizzle)(exports.pool, {
    schema: schema,
    logger: env_js_1.env.NODE_ENV === 'development', // Log SQL queries in dev
});
// ─── Health check helper ─────────────────────────────────────────────────────
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _a = _b.sent();
                    return [2 /*return*/, { ok: false, latencyMs: Date.now() - start }];
